...
# getting representative locus_tags
# representative entries with more than
# one corresponding protein entry will get the mean
spectroWide = left_join(x = spectroWide,
  ...
  summarise(across(.cols = everything(),
                   .fns = ~ mean(.x))) %>% 
  rename(locus_tag = "representative")
